<?php
    ...
    $queryIdEmployee = mysqli_query($connect, "SELECT * FROM `dataemployee` WHERE idaccount='$idAccount'");
    while($row = mysqli_fetch_array($queryIdEmployee)){ 
        $idEmployee = $row["iddataEmployee"];
    }
    error_reporting(0);
?>
<!DOCTYPE html>
            ...
            <table class="br-card-table">
                ...
                <tbody>
                    <tr>
                        <td>
                            <?php
                            $queryTaskDoing  = mysqli_query($connect, "SELECT listtask.task_name, listtask.idlistTask, listtask.status FROM `listtask` INNER JOIN contributiontask ON listtask.idlistTask=contributiontask.idlistTask WHERE contributiontask.iddataEmployee=$idEmployee && listtask.status='Doing' && iddetailOrder='".$_GET['id']."'");
                                ...
                                <div class="place-br-card">
                                    <div class="br-card">
                                        ...
                                        <div class="contribution-task d-flex">
                                            ...
                                            <!-- <svg data-toggle="modal" data-target="#doing<?=$rowDoing["task_name"]?>" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="doing<?=$rowDoing["task_name"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="padding: 0;">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body" style="text-align: left;">
                                                ...
                                                <select name="member" class="form-control">
                                                    ...
                                                    while($row = mysqli_fetch_array($queryMember)){ ?>
                                                    <option value="<?=$row['iddataEmployee']?>"><?=$row["name"]?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="modal-footer">
                        ...
                        <td>
                            <?php
                            $queryTaskProgress  = mysqli_query($connect, "SELECT listtask.task_name, listtask.idlistTask, listtask.status FROM `listtask` INNER JOIN contributiontask ON listtask.idlistTask=contributiontask.idlistTask WHERE contributiontask.iddataEmployee=$idEmployee && listtask.status='Progress' && iddetailOrder='".$_GET['id']."'");
                                ...
                                <div class="place-br-card">
                                    ...
                                    <div class="br-card">
                                        ...
                                        <div class="contribution-task d-flex">
                                            ...
                                            <!-- <svg data-toggle="modal" data-target="#progress<?=$rowProgress["task_name"]?>" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.99984 7.00033H4.6665M6.99984 4.66699V7.00033V4.66699ZM6.99984 7.00033V9.33366V7.00033ZM6.99984 7.00033H9.33317H6.99984Z" stroke="#CDCDCD" stroke-linecap="round"/>
                                                <path d="M6.99984 12.8337C10.2215 12.8337 12.8332 10.222 12.8332 7.00033C12.8332 3.77866 10.2215 1.16699 6.99984 1.16699C3.77818 1.16699 1.1665 3.77866 1.1665 7.00033C1.1665 10.222 3.77818 12.8337 6.99984 12.8337Z" stroke="#CDCDCD"/>
                                            </svg> -->
                                        </div>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="progress<?=$rowProgress["task_name"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="padding: 0;">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add Member</h5>
                        ...
                        <td>
                            <?php
                            $queryTaskCheck  = mysqli_query($connect, "SELECT listtask.task_name, listtask.idlistTask, listtask.status FROM `listtask` INNER JOIN contributiontask ON listtask.idlistTask=contributiontask.idlistTask WHERE contributiontask.iddataEmployee=$idEmployee && listtask.status='Check' && iddetailOrder='".$_GET['id']."'");
                                ...
                                <div class="place-br-card">
                                    ...
                                    <div class="br-card">
                                        ...
                                        <div class="contribution-task d-flex">
                                            ...
                                            <!-- <svg data-toggle="modal" data-target="#check<?=$rowCheck["task_name"]?>" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.99984 7.00033H4.6665M6.99984 4.66699V7.00033V4.66699ZM6.99984 7.00033V9.33366V7.00033ZM6.99984 7.00033H9.33317H6.99984Z" stroke="#CDCDCD" stroke-linecap="round"/>
                                                <path d="M6.99984 12.8337C10.2215 12.8337 12.8332 10.222 12.8332 7.00033C12.8332 3.77866 10.2215 1.16699 6.99984 1.16699C3.77818 1.16699 1.1665 3.77866 1.1665 7.00033C1.1665 10.222 3.77818 12.8337 6.99984 12.8337Z" stroke="#CDCDCD"/>
                                            </svg> -->
                                        </div>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="check<?=$rowCheck["task_name"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="padding: 0;">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add Member</h5>
                        ...
                        <td>
                            <?php
                            $queryTaskDone  = mysqli_query($connect, "SELECT listtask.task_name, listtask.idlistTask, listtask.status FROM `listtask` INNER JOIN contributiontask ON listtask.idlistTask=contributiontask.idlistTask WHERE contributiontask.iddataEmployee=$idEmployee && listtask.status='Done' && iddetailOrder='".$_GET['id']."'");
                                ...
                                <div class="place-br-card">
                                    ...
                                    <div class="br-card">
                                        ...
                                        <div class="contribution-task d-flex">
                                            ...
                                            <!-- <svg data-toggle="modal" data-target="#check<?=$rowDone["task_name"]?>" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M6.99984 7.00033H4.6665M6.99984 4.66699V7.00033V4.66699ZM6.99984 7.00033V9.33366V7.00033ZM6.99984 7.00033H9.33317H6.99984Z" stroke="#CDCDCD" stroke-linecap="round"/>
                                                <path d="M6.99984 12.8337C10.2215 12.8337 12.8332 10.222 12.8332 7.00033C12.8332 3.77866 10.2215 1.16699 6.99984 1.16699C3.77818 1.16699 1.1665 3.77866 1.1665 7.00033C1.1665 10.222 3.77818 12.8337 6.99984 12.8337Z" stroke="#CDCDCD"/>
                                            </svg> -->
                                        </div>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="done<?=$rowDone["task_name"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="padding: 0;">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add Member</h5>
