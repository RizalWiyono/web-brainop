                    ...
                    <div class="card">
                        <div class="card-header" id="heading<?=$no?>">
                            ...
                            <div class="card-footer detail-order flex" style="background: #DA9FF9; align-items: center;">
                                <p data-toggle="modal" data-target="#exampleModal<?=$row['iddetailOrder']?>">Payment proof for <?=$row["project_name"]?>.jpeg</p>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal<?=$row['iddetailOrder']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <img style="width: 100%;" src="../../../src/images/transfer/<?=$row['proof_of_payment']?>" alt="">
                                            </div>
                                ...
                                <form action="fetch/validationOrder.php" method="post">
                                    <input type="hidden" value="<?=$row['iddetailOrder']?>" class="form-control" name="idParam">
                                    <button type="submit" class="ml-3 btn btn-light" style="background-color: #B088F9; border: 0; font-size: 12px; color: #FFF;">Validate payment</button>
                                </form>
                            </div>
                        </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="heading<?=$no?>">
                            <h2 class="mb-0 d-flex">
                                ...
                                <button class="btn btn-warning" data-toggle="modal" data-target="#mdUpd<?=$row['iddetailOrder']?>">Update</button>
                            </h2>
                            </div>
